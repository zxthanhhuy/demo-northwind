...
@Configuration
@EnableNeo4jRepositories(basePackages = "northwind.repositories", queryLookupStrategy = QueryLookupStrategy.Key.CREATE_IF_NOT_FOUND)
...
public class Neo4jConfig extends Neo4jConfiguration {
  ...
  public SessionFactory getSessionFactory() {
    ...
    SessionFactory sessionFactory = new SessionFactory("northwind.entities");
